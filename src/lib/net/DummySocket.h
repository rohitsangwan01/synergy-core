...
*/
class DummySocket : public IDataSocket {
public:
  DummySocket(IEventQueue *events, SocketMultiplexer *socketMultiplexer,
              IArchNetwork::EAddressFamily family = IArchNetwork::kINET);
  DummySocket(IEventQueue *events, SocketMultiplexer *socketMultiplexer,
              ArchSocket socket);
  DummySocket(DummySocket const &) = delete;
  DummySocket(DummySocket &&) = delete;
  virtual ~DummySocket();

  DummySocket &operator=(DummySocket const &) = delete;
  DummySocket &operator=(DummySocket &&) = delete;
