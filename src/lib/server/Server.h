...
public:
  ...
  */
  ...
  void setDummyListener(DummyClientListener *p) { m_dummy_clientListener = p; }
...
private:
  ...
  BaseClientProxy *mapToNeighbor(BaseClientProxy *, EDirection, SInt32 &x,
                                 SInt32 &y) const;
  ...
  // event processing
  void onClipboardChanged(BaseClientProxy *sender, ClipboardID id,
                          UInt32 seqNum);
...
private:
  ...
  DummyClientListener *m_dummy_clientListener;
